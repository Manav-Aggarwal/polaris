...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/rollkit/cosmos-sdk v0.50.6-rollkit-v0.13.2-no-fraud-proofs
...
require (
	...
	github.com/berachain/polaris/eth v0.1.5-alpha
...
require (
	...
	github.com/rollkit/rollkit v0.13.2 // indirect
